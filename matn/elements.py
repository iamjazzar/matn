...
DIACRITICS = DIACRITICS_MAPPINGS.values()
...
LETTERS = BASIC_LETTERS + HAMZA_LETTERS + (TA_MARBUTA,) + (ALIF_MAQSURA,)
...
PUNCTUATION_MARKS = (
    ARABIC_PUNCTUATION_MARKS + OTHER_PUNCTUATION_MARKS + NUMBERS_PUNCTUATION_MARKS
)
